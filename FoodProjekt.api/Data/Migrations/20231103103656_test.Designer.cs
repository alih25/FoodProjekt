            ...
            modelBuilder.Entity("FoodProjekt.api.Data.Entities.Offer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OfferedValue = 50m,
                            Type = 1,
                            ValidTill = new DateTime(2023, 11, 10, 11, 36, 55, 979, DateTimeKind.Local).AddTicks(9614)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        new
                        {
                            ...
                            OfferedValue = 70m,
                            Type = 1,
                            ValidTill = new DateTime(2023, 11, 5, 11, 36, 55, 979, DateTimeKind.Local).AddTicks(9707)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            OfferedValue = 40m,
                            Type = 1,
                            ValidTill = new DateTime(2023, 11, 7, 11, 36, 55, 979, DateTimeKind.Local).AddTicks(9719)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            OfferedValue = 30m,
                            Type = 1,
                            ValidTill = new DateTime(2023, 12, 3, 11, 36, 55, 979, DateTimeKind.Local).AddTicks(9724)
                        });
                });
